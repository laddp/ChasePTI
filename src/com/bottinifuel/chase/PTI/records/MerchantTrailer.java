 ...
 *
 */
public class MerchantTrailer extends PTIRecord
{
    public static final String FormatStr =
        "{text:width=2} "   +  // RecordID "MT"
     ...
     * @param hdr
     */
    public MerchantTrailer(int lineNum, String data) throws ParseException
    {
        super(RecordType.MerchantTrailer, lineNum, data.substring(0,9));
