 ...
 *
 */
public class BankTrailer extends PTIRecord
{
    public static final String FormatStr =
        "{text:width=2} "   +  // RecordID "ST"
     ...
     * @param hdr
     */
    public BankTrailer(int lineNum, String data) throws ParseException
    {
        super(RecordType.BankTrailer, lineNum, data.substring(0,9));
