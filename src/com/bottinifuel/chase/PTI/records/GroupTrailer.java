 ...
 *
 */
public class GroupTrailer extends PTIRecord
{
    public static final String FormatStr =
        "{text:width=2} "   +  // RecordID "GT"
     ...
     * @param hdr
     */
    public GroupTrailer(int lineNum, String data) throws ParseException
    {
        super(RecordType.GroupTrailer, lineNum, data.substring(0,9));
